...
//  Login
//
//  Created by hyejeong im on 10/10/24.
//
...
/**
 ...
 setNeedsLayout()
 - 다음 updateCycle에 들어갔을 때 뷰 갱신
 - 갱신을 예약해두고 다음 사이클에 재계산된 뷰가 반영되기 때문에 성능상의 이점이 있음.
 layoutIfNeeded()
 - 다음 updateCycle을 기다리지 않고 즉시 뷰 갱신
 - 즉각적 동작이 필요한 애니메이션에서 주로 사용됨.
 */
